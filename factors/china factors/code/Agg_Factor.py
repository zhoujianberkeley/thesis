...
macro = macro.sort_index().shift(1) # shift macro factor also by 1
...
# add interaction terms among macro and stock features
...
full_factors_y = full_factors_y.dropna(subset=['excess_return'])
